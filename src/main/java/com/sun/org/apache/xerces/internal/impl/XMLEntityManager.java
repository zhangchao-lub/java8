...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
    ...
    public String setupCurrentEntity(String name, XMLInputSource xmlInputSource,
         ...
         */
        //boolean isGE, String name, XMLResourceIdentifier entityLocation, InputStream stream, Reader reader, String encoding, boolean literal, boolean mayReadChunks, boolean isExternal
        /** 自己改的*/
        fCurrentEntity = new com.sun.xml.internal.stream.Entity.ScannedEntity(true,name,new XMLResourceIdentifierImpl(publicId, literalSystemId, baseSystemId, expandedSystemId),stream, reader, encoding, literal, encodingExternallySpecified, isExternal);
